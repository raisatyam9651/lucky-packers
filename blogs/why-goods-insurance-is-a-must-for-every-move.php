                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">Goods Insurance Guide</h2>
                    ...
                    <div class="col-lg-8">
                        <div class="blog__details-content">
                            <div class="blog__details-thumb" style="border: 1px solid #eee; border-radius: 10px; overflow: hidden; margin-bottom: 30px;">
                                ...
                                <img src="<?php echo $base_url; ?>assets/media/blogs/goods-insurance-feature.png" alt="Why Goods Insurance is a Must for Every Move" style="width: 100%;">
                            ...
                            <h3 style="color: #0A4D68; font-weight: 700;">How LC Packers and Mover Assists You</h3>
                            <p>We believe in total transparency. When you choose <strong>LC Packers and Mover</strong>, we help you with:</p>
                            <ul class="list-wrap" style="margin-bottom: 30px;">
                            ...
                            <p>Your belongings are more than just items; they are a part of your life. Protecting them with goods insurance is the smartest decision you can make during a move. Don't leave your relocation to chance. Partner with <strong>LC Packers and Mover</strong> and enjoy a fully insured, worry-free move today!</p>
