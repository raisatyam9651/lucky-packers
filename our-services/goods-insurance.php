                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">Goods Insurance</h2>
                        ...
                        <div class="col-70 order-0 order-lg-2">
                            <div class="services__details-thumb">
                                <img src="<?php echo $base_url; ?>assets/media/services/lc-packers-packing-main.png"
                                    alt="Comprehensive Goods Insurance Services by LC Packers and Movers"
                            ...
                            <div class="services__details-content">
                                ...
                                <h2>Key Benefits of Choosing LC Packers and Movers</h2>
                                <ul>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        Q1: How is the insurance premium calculated?
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        Q3: Are there any items that cannot be insured?
                                                    </button>
                                                </h2>
                                ...
                                <h2>Conclusion</h2>
                                <p>Don't leave the safety of your valuables to chance. At <strong>LC Packers and Movers PVT. LTD.</strong>, we provide the protection you need for a truly worry-free relocation. Contact us today for a free, no-obligation quote and let us take the risk out of your next move!</p>
                            </div>
                        </div>
                        <div class="col-30">
