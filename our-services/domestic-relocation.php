                        ...
                        <div class="col-70 order-0 order-lg-2">
                            <div class="services__details-thumb">
                                <img src="<?php echo $base_url; ?>assets/media/services/lc-packers-transport-main.png"
                                    alt="Domestic Relocation Services by LC Packers and Movers"
                            ...
                            <div class="services__details-content">
                                ...
                                <h2>Why Choose LC Packers and Movers for Domestic Relocation?</h2>
                                <ul>
                                ...
                                <h2>Conclusion</h2>
                                <p>At <strong>LC Packers and Movers PVT. LTD.</strong>, we make the load of domestic relocation easy. Contact us now for a free quote and experience a stress-free move across India with the country's most trusted relocation partner!</p>
                            </div>
                        </div>
                        <div class="col-30">
