                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <h2 class="title">Custom Clearance</h2>
                            <nav class="breadcrumb">
                                ...
                                <span class="breadcrumb-separator"><i class="flaticon-right-arrow"></i></span>
                                <span property="itemListElement" typeof="ListItem" class="active_page">Custom Clearance</span>
                            </nav>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="services__details-inner-img">
                                                <img src="<?php echo $base_url; ?>assets/media/services/lc-packers-transport-01.png"
                                                    alt="Professional customs documentation being prepared for international shipment"
                                                    title="Customs Documentation Prep">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="services__details-inner-img">
                                                <img src="<?php echo $base_url; ?>assets/media/services/lc-packers-transport-02.png"
                                                    alt="Successful customs clearance of international cargo"
                                                    title="Global Cargo Clearance">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="blog-widget">
                                    ...
                                    <div class="shop-cat-list">
                                        <ul class="list-wrap">
                                            ...
                                            <li>
                                                <a class="active" href="<?php echo $base_url; ?>our-services/custom-clearance.php" title="Custom Clearance Services">Custom Clearance</a>
                                            </li>
                                            <li>
